...
export default function Home() {
    ...
    return (
        <main className="flex min-h-screen flex-col px-4 lg:px-8 xl:px-24">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 grid-rows-4 gap-4">
                ...
                <Card className="row-span-3">
                    ...
                    <div className="flex items-center justify-between lg:px-2 xl:px-4 2xl:px-6 pb-4">
                ...
                <Calendar mode="single" selected={date} onSelect={setDate} className="row-span-3 rounded-md" />
            </div>
        </main>
    );
}
